...
internal static class PluginConfig
{
    ...
    internal static void Init()
    {
        ...
        LogWrapping.Enabled = _config.Bind("LogWrapping", "Enabled", 
            false, "Look into game assemblies and tweak calls to Unity.Debug");
        LogWrapping.TargetAssemblies = _config.Bind("LogWrapping", "Target Assemblies",
            "Assembly-CSharp.dll,Other-assembly.dll", "Which Assemblies to look into");
        //Timestamps
    ...
    {
        public static ConfigEntry<bool> Enabled;
        public static ConfigEntry<string> TargetAssemblies;
    }
